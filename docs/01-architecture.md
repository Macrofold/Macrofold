...
Revision: September 6, 2026. This is the current design; [decision log](15-implementation-review.md) explains changes from the initial proposal. [Verification](16-implementation-status.md) distinguishes local acceptance from live-provider checks.
...
See [runtime](17-runtime-implementation.md), [workspace design](03-workspaces.md), [security/tools](19-tools-and-security.md), [deployment](22-deployment.md) and [launch instructions](18-launch-guide.md) for the corresponding implementation and operator procedures.
