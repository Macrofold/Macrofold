...
Avina-CoWork is an example customer repository, not a build dependency. Connect it using the GitHub App or explicit file transfers. Project instructions remain ordinary customer files and cannot change platform grants or funding policy.
