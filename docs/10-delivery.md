...
The product is implemented locally; live hosting, model billing and external account acceptance remain operator launch steps. [16-implementation-status.md](16-implementation-status.md) is the evidence record, [requirements.csv](requirements.csv) maps the 51 original requirements, and [18-launch-guide.md](18-launch-guide.md) is the launch procedure.
