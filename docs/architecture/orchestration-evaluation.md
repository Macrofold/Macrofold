# Workflow and Temporal evaluation

This is supporting technical research for [ARC-03 in the improvements tracker](../product/improvements.md#arc-03-evaluate-durable-orchestration-alternatives-when-coordination-requires-them), which owns priority and status. It does not change the [accepted architecture](decisions.md) or commit to a migration. The [architecture overview](README.md) and [release TODO](../maintainers/TODO.md) remain authoritative for implemented behavior and launch work.
