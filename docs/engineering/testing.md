...
| `Generated SDK contracts and transports` | Pinned generation drift, Go/Rust/Java HTTP and SSE fixtures, and actual API/simulator execution on a disposable database. |
