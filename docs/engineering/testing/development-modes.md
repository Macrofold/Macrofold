...
- The image build isolates the runtime workspace because filtering the full pnpm workspace still installed unrelated application/test packages. Native dependencies retain the shared frozen lock and approved install policy.
