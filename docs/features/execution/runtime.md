...
[Server operations](workers/operations.md) explains pricing, maintenance and provider limitations; [acceptance](workers/verification.md) distinguishes local evidence from live checks.
