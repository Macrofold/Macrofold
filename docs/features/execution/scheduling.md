...
This document describes the current scheduling policy. The implementation retains the modular Next.js control plane, PostgreSQL outbox, Vercel execution adapter, optional standalone poller, SSE, persistent workspaces and immutable credit ledger.
