...
Each delivery resolves [connector access](../identity-integrations/connection-access.md) using the configured project and verified preset. Explicit preset tool defaults narrow access; omitted defaults inherit current eligible connections. Event payloads cannot supply access exceptions or change this context.
