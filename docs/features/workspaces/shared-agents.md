...
After [setting up the Python SDK](../../../sdk/python/README.md), use two saved agent presets authorized for the project:
...
See [workspace and Git behavior](README.md), [read files through the API](read-files.md), and [run lifecycle](../execution/README.md).
