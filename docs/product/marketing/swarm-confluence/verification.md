...
The [Confluence collection](README.md) was checked locally in Chrome 152.0.7977.83 with ANGLE Metal on Apple M1 Pro. The [final reviews](../../../../output/swarm-confluence/review-final/review-report.json), [still captures](../../../../output/swarm-confluence/final-captures/capture-report.json), [browser report](../../../../output/swarm-confluence/ui-report.json), and [renderer regression](../../../../output/swarm-confluence/renderer-report.json) bind the delivered source. Renderer SHA-256 is `8414877acc98233cd01e2e78aef277da81d8cf3e831b35ed6d4d70bd6fa7162b`; geometry SHA-256 is `bdb50551372ae5984cbe2982cdd5f1b774adfee7d8483e13d60067cc42988557`.
...
Desktop and 390-pixel mobile checks report zero tested Axe violations and no horizontal overflow. The [desktop screenshot](../../../../output/swarm-confluence/ui-desktop.png) and [native mobile screenshot](../../../../output/swarm-confluence/mobile-native-full-page.png) were visually inspected. A separate [native-clock compositor check](../../../../output/swarm-confluence/mobile-compositor-report.json) confirms visible particles in viewport, full-page, and stage captures, with 24,457 visible framebuffer alpha pixels and no graphics errors. Callback timing in the UI report is not a native GPU performance benchmark.

## Delivery and preservation

Ten transparent 2880 × 1920 PNGs total 46,583,254 bytes; ten 1440 × 960 WebPs total 9,053,866 bytes. [Publication](../../../../output/swarm-confluence/image-report.json) verifies dimensions, alpha, capture identity, and source hashes. The live renderer loads approximately 1.98 MB of shared geometry, renderer, metadata, and palette before UI/poster assets; it does not load the entire still collection. The extra particle identities reuse the existing palette asset.

The [source archive](../../../../output/swarm-confluence-source.zip) contains 36 files and is 57,026,875 bytes, with SHA-256 `9e28f16d02d4c008065f9db0d7799f408ab7b7ba3b1a5b0dc3e2bac749998b0f`. Its [package report](../../../../output/swarm-confluence/package-report.json) binds runtime, capture, and test evidence. Independent ZIP integrity and all 35 manifest entries pass, including portable capture-tool paths. The [preservation report](../../../../output/swarm-confluence/preservation-after.json) confirms all 220 recorded earlier public files and source archives remain byte-identical.
