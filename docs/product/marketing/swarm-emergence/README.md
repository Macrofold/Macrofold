...
Ten transparent 2880 × 1920 PNG stills and 1440 × 960 WebP posters accompany the live collection. The [standalone source package](../../../../output/swarm-emergence-source.zip) contains all runtime files, required data, stills, and a capture tool. [Capture and packaging instructions](../../../../output/swarm-emergence/README.md) explain deterministic replay and source preservation. Video remains deferred by user choice. The [verification record](verification.md) owns actual checks and device-coverage limits.
