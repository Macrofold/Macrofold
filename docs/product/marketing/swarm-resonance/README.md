...
Ten transparent 2880 × 1920 PNG stills and 1440 × 960 WebP posters accompany the live collection. The standalone source ZIP (`../../../../output/swarm-resonance-source.zip`, local historical evidence not included in this repository) contains all runtime files, required data, stills, and the optional capture tool. Tool instructions (`../../../../output/swarm-resonance/README.md`, local historical evidence not included in this repository) explain capture and preservation; [verification](verification.md) records actual checks and coverage limits. Video remains deferred by user choice.
