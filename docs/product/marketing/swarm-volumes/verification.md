...
Local verification for the [volume collection](README.md) completed on 9 September 2026 with Chrome 152.0.7977.83 and ANGLE Metal on Apple M1 Pro. The capture report (`../../../../output/swarm-volumes/final-captures/capture-report.json`, local historical evidence not included in this repository), motion review (`../../../../output/swarm-volumes/final-motion-review/review-report.json`, local historical evidence not included in this repository), and UI report (`../../../../output/swarm-volumes/ui-report.json`, local historical evidence not included in this repository) bind their results to the delivered source. The renderer SHA-256 is `f6ab2d4db0118ab63959a47a0b9fe742a51c5d99f016b5690dff7db9665647f3`.
...
The standalone source ZIP (`../../../../output/swarm-volumes-source.zip`, local historical evidence not included in this repository) contains 35 files and is 25,493,748 bytes. Its SHA-256 is `b84128adf21b4159e284645c11c3872e076eaec59fabbf0641c6cbd2be3e1545`. ZIP integrity and every packaged manifest hash were checked. The package report (`../../../../output/swarm-volumes/package-report.json`, local historical evidence not included in this repository) verifies that the packaged runtime matches the capture and UI source hashes and that the PNGs match the rendered exports. The preservation check (`../../../../output/swarm-volumes/preservation-after.json`, local historical evidence not included in this repository) confirms that all 74 recorded earlier files, including previous runtime folders and source archives, remain byte-identical.
