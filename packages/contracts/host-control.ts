...
export const hostHealth = z.object({
  boot_id: z.uuid(), started_at: z.string(), configured: z.boolean(), quiesced: z.boolean().optional(), rotation_requested: z.boolean().optional(), active_assignments: z.number().int().nonnegative(),
