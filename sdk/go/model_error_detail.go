...
func NewErrorDetail(code string, message string, requestId string, retryable bool) *ErrorDetail {
	this := ErrorDetail{}
	this.Code = code
...
func (o *ErrorDetail) GetRetryable() bool {
	if o == nil {
		var ret bool
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ErrorDetail) GetRetryableOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ErrorDetail) SetRetryable(v bool) {
	o.Retryable = v
}
