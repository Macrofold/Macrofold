...
func NewInvitationCreate(email string, role string) *InvitationCreate {
...
func (o *InvitationCreate) GetRole() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *InvitationCreate) GetRoleOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Role, true
...
func (o *InvitationCreate) SetRole(v string) {
	o.Role = v
}
...
func (o *InvitationCreate) UnmarshalJSON(data []byte) (err error) {
	...
	err = decoder.Decode(&varInvitationCreate)
