...
func NewListAccounts200Response(data []Account, nextCursor NullableString) *ListAccounts200Response {
...
func (o *ListAccounts200Response) GetNextCursor() string {
...
func (o *ListAccounts200Response) GetNextCursorOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ListAccounts200Response) SetNextCursor(v string) {
	o.NextCursor.Set(&v)
}
