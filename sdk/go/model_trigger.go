...
func (o *Trigger) GetAgentId() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *Trigger) GetAgentIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Trigger) SetAgentId(v string) {
	o.AgentId = v
}

// GetKind returns the Kind field value
func (o *Trigger) GetKind() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *Trigger) GetKindOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Kind, true
...
func (o *Trigger) SetKind(v string) {
	o.Kind = v
}

// GetPrompt returns the Prompt field value
func (o *Trigger) GetPrompt() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *Trigger) GetPromptOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Trigger) SetPrompt(v string) {
	o.Prompt = v
}
...
func (o *Trigger) GetMaxRunsPerDay() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *Trigger) GetMaxRunsPerDayOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Trigger) SetMaxRunsPerDay(v int32) {
	o.MaxRunsPerDay = v
}

// GetCron returns the Cron field value if set, zero value otherwise.
func (o *Trigger) GetCron() string {
...
// and a boolean to check if the value has been set.
func (o *Trigger) GetCronOk() (*string, bool) {
	if o == nil || IsNil(o.Cron) {
		return nil, false
	}
	return o.Cron, true
...
func (o *Trigger) SetCron(v string) {
	o.Cron = &v
}

// GetTimezone returns the Timezone field value if set, zero value otherwise.
func (o *Trigger) GetTimezone() string {
...
// and a boolean to check if the value has been set.
func (o *Trigger) GetTimezoneOk() (*string, bool) {
	if o == nil || IsNil(o.Timezone) {
		return nil, false
	}
...
func (o *Trigger) HasTimezone() bool {
	if o != nil && !IsNil(o.Timezone) {
		return true
	}
...
func (o *Trigger) SetTimezone(v string) {
	o.Timezone = &v
}

// GetSlackConnectionId returns the SlackConnectionId field value
// If the value is explicit nil, the zero value for string will be returned
func (o *Trigger) GetSlackConnectionId() string {
...
func (o *Trigger) GetSlackConnectionIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Trigger) SetSlackConnectionId(v string) {
	o.SlackConnectionId.Set(&v)
}

// GetChannelId returns the ChannelId field value
// If the value is explicit nil, the zero value for string will be returned
func (o *Trigger) GetChannelId() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *Trigger) GetChannelIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Trigger) SetChannelId(v string) {
	o.ChannelId.Set(&v)
}
...
func (o *Trigger) GetNextFireAt() time.Time {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *Trigger) GetNextFireAtOk() (*time.Time, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Trigger) SetNextFireAt(v time.Time) {
	o.NextFireAt.Set(&v)
}

// GetLastErrorCode returns the LastErrorCode field value
// If the value is explicit nil, the zero value for string will be returned
func (o *Trigger) GetLastErrorCode() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *Trigger) GetLastErrorCodeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Trigger) SetLastErrorCode(v string) {
	o.LastErrorCode.Set(&v)
}

// GetLastFiredAt returns the LastFiredAt field value
// If the value is explicit nil, the zero value for time.Time will be returned
func (o *Trigger) GetLastFiredAt() time.Time {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *Trigger) GetLastFiredAtOk() (*time.Time, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Trigger) SetLastFiredAt(v time.Time) {
	o.LastFiredAt.Set(&v)
}

// GetWebhookUrl returns the WebhookUrl field value
// If the value is explicit nil, the zero value for string will be returned
func (o *Trigger) GetWebhookUrl() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *Trigger) GetWebhookUrlOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Trigger) SetWebhookUrl(v string) {
	o.WebhookUrl.Set(&v)
}
