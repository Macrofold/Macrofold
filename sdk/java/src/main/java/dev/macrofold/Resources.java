...
public ListCustomerAgentRunEvents200Response listEvents(UUID runId) throws ApiException {
        return listEvents(runId,new ListRunEventsParams());
      }
public ListCustomerAgentRunEvents200Response listEvents(UUID runId,ListRunEventsParams params) throws ApiException {
...
public DeleteSlackConnection200Response delete(UUID triggerId) throws ApiException {
...
public ListCustomerAgentRunEvents200Response listRunEvents(String customerId,UUID customerAgentId,UUID runId) throws ApiException {
        return listRunEvents(customerId,customerAgentId,runId,new ListCustomerAgentRunEventsParams());
      }
public ListCustomerAgentRunEvents200Response listRunEvents(String customerId,UUID customerAgentId,UUID runId,ListCustomerAgentRunEventsParams params) throws ApiException {
...
public DeleteSlackConnection200Response delete(UUID connectionId) throws ApiException {
...
public InferenceResponse create(InferenceCreate input,CreateInferenceParams params) throws ApiException {
        if (input != null && Boolean.TRUE.equals(input.getStream())) throw new IllegalArgumentException("use inferences().stream for incremental output");
        String key=options.identity();
        Objects.requireNonNull(params,"params");
