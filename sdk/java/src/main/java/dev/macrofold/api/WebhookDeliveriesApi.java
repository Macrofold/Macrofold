...
import dev.macrofold.model.ListWebhookDeliveries200Response;
...
public class WebhookDeliveriesApi {
   ...
   */
  public ListWebhookDeliveries200Response listWebhookDeliveries(@javax.annotation.Nullable String cursor, @javax.annotation.Nullable Integer limit, @javax.annotation.Nullable UUID xOrganizationId) throws ApiException {
    return listWebhookDeliveries(cursor, limit, xOrganizationId, null);
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ListWebhookDeliveries200Response listWebhookDeliveries(@javax.annotation.Nullable String cursor, @javax.annotation.Nullable Integer limit, @javax.annotation.Nullable UUID xOrganizationId, Map<String, String> headers) throws ApiException {
    ApiResponse<ListWebhookDeliveries200Response> localVarResponse = listWebhookDeliveriesWithHttpInfo(cursor, limit, xOrganizationId, headers);
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<ListWebhookDeliveries200Response> listWebhookDeliveriesWithHttpInfo(@javax.annotation.Nullable String cursor, @javax.annotation.Nullable Integer limit, @javax.annotation.Nullable UUID xOrganizationId) throws ApiException {
    return listWebhookDeliveriesWithHttpInfo(cursor, limit, xOrganizationId, null);
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<ListWebhookDeliveries200Response> listWebhookDeliveriesWithHttpInfo(@javax.annotation.Nullable String cursor, @javax.annotation.Nullable Integer limit, @javax.annotation.Nullable UUID xOrganizationId, Map<String, String> headers) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = listWebhookDeliveriesRequestBuilder(cursor, limit, xOrganizationId, headers);
    try {
      ...
      try {
        ...
        if (localVarResponseBody == null) {
          return new ApiResponse<ListWebhookDeliveries200Response>(
        ...
        ListWebhookDeliveries200Response responseValue = responseBody.isBlank()? null: memberVarObjectMapper.readValue(responseBody, new TypeReference<ListWebhookDeliveries200Response>() {});
  ...
  private HttpRequest.Builder listWebhookDeliveriesRequestBuilder(@javax.annotation.Nullable String cursor, @javax.annotation.Nullable Integer limit, @javax.annotation.Nullable UUID xOrganizationId, Map<String, String> headers) throws ApiException {

    HttpRequest.Builder localVarRequestBuilder = HttpRequest.newBuilder();

    String localVarPath = "/v1/webhook-deliveries";
  ...
  public ApiResponse<Operation> replayWebhookDeliveryWithHttpInfo(@javax.annotation.Nonnull UUID deliveryId, @javax.annotation.Nonnull String idempotencyKey, @javax.annotation.Nonnull Object body, @javax.annotation.Nullable UUID xOrganizationId, Map<String, String> headers) throws ApiException {
    ...
    try {
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("replayWebhookDelivery", localVarResponse);
        }
        localVarResponseBody = ApiClient.getResponseBody(localVarResponse);
        if (localVarResponseBody == null) {
  ...
  private HttpRequest.Builder replayWebhookDeliveryRequestBuilder(@javax.annotation.Nonnull UUID deliveryId, @javax.annotation.Nonnull String idempotencyKey, @javax.annotation.Nonnull Object body, @javax.annotation.Nullable UUID xOrganizationId, Map<String, String> headers) throws ApiException {
    ...
    String localVarPath = "/v1/webhook-deliveries/{delivery_id}/replay"
