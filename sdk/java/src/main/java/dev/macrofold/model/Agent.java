...
@JsonPropertyOrder({
  ...
  Agent.JSON_PROPERTY_CONNECTIONS
})
...
public class Agent {
  ...
  public Agent connections(@javax.annotation.Nullable ContextualConnectionPage connections) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, agent.name) &&
        ...
        Objects.equals(this.connections, agent.connections);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, harness, model, instructions, billingMode, providerConnectionId, connectionGrants, limits, id, organizationId, version, createdAt, connections);
  }
