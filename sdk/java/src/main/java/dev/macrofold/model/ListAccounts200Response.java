 ...
 */
@JsonPropertyOrder({
  ListAccounts200Response.JSON_PROPERTY_DATA,
  ListAccounts200Response.JSON_PROPERTY_NEXT_CURSOR
})
...
public class ListAccounts200Response {
  ...
  public ListAccounts200Response data(@javax.annotation.Nonnull List<Account> data) {
    this.data = data;
    return this;
  }

  public ListAccounts200Response addDataItem(Account dataItem) {
    if (this.data == null) {
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(@javax.annotation.Nonnull List<Account> data) {
    this.data = data;
  }


  public ListAccounts200Response nextCursor(@javax.annotation.Nullable String nextCursor) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, listAccounts200Response.data) &&
        Objects.equals(this.nextCursor, listAccounts200Response.nextCursor);
  }
