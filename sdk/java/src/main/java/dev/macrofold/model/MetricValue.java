...
@JsonDeserialize(using = MetricValue.MetricValueDeserializer.class)
@JsonSerialize(using = MetricValue.MetricValueSerializer.class)
public class MetricValue extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(MetricValue.class.getName());

    public static class MetricValueSerializer extends StdSerializer<MetricValue> {
        public MetricValueSerializer(Class<MetricValue> t) {
            super(t);
        }

        public MetricValueSerializer() {
            this(null);
        }

        @Override
        public void serialize(MetricValue value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class MetricValueDeserializer extends StdDeserializer<MetricValue> {
        public MetricValueDeserializer() {
            this(MetricValue.class);
        }

        public MetricValueDeserializer(Class<?> vc) {
            super(vc);
        }

        @Override
        public MetricValue deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for MetricValue: %d classes match result, expected 1", match));
        }
         ...
         */
        @Override
        public MetricValue getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            return null;
        }
    }
    ...
    public MetricValue(BigDecimal o) {
        super("oneOf", Boolean.TRUE);
        setActualInstance(o);
    }

    public MetricValue(String o) {
        super("oneOf", Boolean.TRUE);
        setActualInstance(o);
    }
    ...
    static {
        ...
        JSON.registerDescendants(MetricValue.class, Collections.unmodifiableMap(schemas));
    }

    @Override
    public Map<String, Class<?>> getSchemas() {
        return MetricValue.schemas;
    }
