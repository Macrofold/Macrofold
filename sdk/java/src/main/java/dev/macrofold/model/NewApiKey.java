...
@JsonPropertyOrder({
  ...
  NewApiKey.JSON_PROPERTY_SECRET
})
...
public class NewApiKey {
  ...
  public NewApiKey id(@javax.annotation.Nonnull UUID id) {
    this.id = id;
    return this;
  }
  ...
  public NewApiKey name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public NewApiKey prefix(@javax.annotation.Nonnull String prefix) {
    this.prefix = prefix;
    return this;
  }
  ...
  public NewApiKey scopes(@javax.annotation.Nonnull List<String> scopes) {
    this.scopes = scopes;
    return this;
  }

  public NewApiKey addScopesItem(String scopesItem) {
    if (this.scopes == null) {
  ...
  public NewApiKey lastUsedAt(@javax.annotation.Nullable OffsetDateTime lastUsedAt) {
  ...
  public NewApiKey expiresAt(@javax.annotation.Nullable OffsetDateTime expiresAt) {
  ...
  public NewApiKey revokedAt(@javax.annotation.Nullable OffsetDateTime revokedAt) {
  ...
  /**
   * Return true if this NewApiKey object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, newApiKey.id) &&
        ...
        Objects.equals(this.secret, newApiKey.secret);
  }
