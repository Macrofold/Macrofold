...
public class WorkspacePatch {
  ...
  public WorkspacePatch name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public WorkspacePatch permissions(@javax.annotation.Nullable AgentPermissions permissions) {
  ...
  /**
   * Return true if this WorkspacePatch object is equal to o.
   */
  @Override
