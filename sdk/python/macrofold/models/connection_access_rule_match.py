...
class ConnectionAccessRuleMatch(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["rule_id", "scope", "workspace_id", "agent_id", "workspace_name", "agent_name"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ConnectionAccessRuleMatch from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ConnectionAccessRuleMatch from a dict"""
        if obj is None:
            return None
