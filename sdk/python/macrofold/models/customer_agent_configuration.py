...
class CustomerAgentConfiguration(BaseModel):
    """
    ...
    limits: Limits
    __properties: ClassVar[List[str]] = ["harness", "model", "instructions", "billing_mode", "provider_connection_id", "limits"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CustomerAgentConfiguration from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CustomerAgentConfiguration from a dict"""
        if obj is None:
            return None
