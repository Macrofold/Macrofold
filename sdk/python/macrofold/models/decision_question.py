...
class DecisionQuestion(BaseModel):
    ...
    DecisionQuestion
    """
    # data type: DecisionQuestionOneOf
    oneof_schema_1_validator: Optional[DecisionQuestionOneOf] = None
    # data type: DecisionQuestionOneOf1
    ...
    def actual_instance_must_validate_oneof(cls, v):
        instance = DecisionQuestion.model_construct()
        error_messages = []
        match = 0
        # validate data type: DecisionQuestionOneOf
        if not isinstance(v, DecisionQuestionOneOf):
            error_messages.append(f"Error! Input type `{type(v)}` is not `DecisionQuestionOneOf`")
        else:
            match += 1
        # validate data type: DecisionQuestionOneOf1
        if not isinstance(v, DecisionQuestionOneOf1):
            error_messages.append(f"Error! Input type `{type(v)}` is not `DecisionQuestionOneOf1`")
        else:
            match += 1
        # validate data type: DecisionQuestionOneOf2
        if not isinstance(v, DecisionQuestionOneOf2):
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # deserialize data into DecisionQuestionOneOf
        try:
            instance.actual_instance = DecisionQuestionOneOf.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        # deserialize data into DecisionQuestionOneOf1
        try:
            instance.actual_instance = DecisionQuestionOneOf1.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        # deserialize data into DecisionQuestionOneOf2
        try:
            instance.actual_instance = DecisionQuestionOneOf2.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
