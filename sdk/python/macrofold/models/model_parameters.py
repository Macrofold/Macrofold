...
class ModelParameters(BaseModel):
    ...
    ModelParameters
    """ # noqa: E501
    reasoning: Optional[ModelParametersReasoning] = None
    provider: Optional[ModelParametersProvider] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["reasoning", "provider"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "reasoning": ModelParametersReasoning.from_dict(obj["reasoning"]) if obj.get("reasoning") is not None else None,
            "provider": ModelParametersProvider.from_dict(obj["provider"]) if obj.get("provider") is not None else None
        })
