...
class NativeRunAccepted(BaseModel):
    """
    NativeRunAccepted
    """ # noqa: E501
    run_id: UUID
    ...
    def kind_validate_enum(cls, value):
        ...
        if value not in set(['native_agent']):
            raise ValueError("must be one of enum values ('native_agent')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NativeRunAccepted from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NativeRunAccepted from a dict"""
        if obj is None:
            return None
