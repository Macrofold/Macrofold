...
class NewApiKey(BaseModel):
    ...
    secret: StrictStr = Field(description="Displayed once at creation; never returned again.")
    __properties: ClassVar[List[str]] = ["id", "name", "prefix", "scopes", "workspace_id", "last_used_at", "expires_at", "revoked_at", "secret"]
