...
class Workspace(BaseModel):
    ...
    github: Optional[WorkspaceGithub] = None
    created_at: datetime
    ...
    default_worktree_id: Optional[UUID] = None
    ...
    __properties: ClassVar[List[str]] = ["id", "organization_id", "name", "persistence", "github", "created_at", "storage_bytes", "archived", "default_worktree_id", "revision", "deletion_due_at", "deletion_requested_at", "permissions", "connections"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "github": WorkspaceGithub.from_dict(obj["github"]) if obj.get("github") is not None else None,
            "created_at": obj.get("created_at"),
            "storage_bytes": obj.get("storage_bytes"),
            "archived": obj.get("archived"),
            "default_worktree_id": obj.get("default_worktree_id"),
