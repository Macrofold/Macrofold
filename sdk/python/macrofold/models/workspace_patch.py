...
class WorkspacePatch(BaseModel):
    ...
    github: Optional[WorkspaceCreateGithub] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WorkspacePatch from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WorkspacePatch from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "github": WorkspaceCreateGithub.from_dict(obj["github"]) if obj.get("github") is not None else None,
