...
/// 
pub async fn list_models(configuration: &configuration::Configuration, harness: Option<&str>, cursor: Option<&str>, limit: Option<i32>, x_organization_id: Option<&str>) -> Result<models::ListModels200Response, Error<ListModelsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_harness = harness;
    ...
    if let Some(ref param_value) = p_query_harness {
        req_builder = req_builder.query(&[("harness", &param_value.to_string())]);
    }
