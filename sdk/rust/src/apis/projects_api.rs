...
pub async fn get_project(configuration: &configuration::Configuration, project_id: &str, x_organization_id: Option<&str>, include_connections: Option<bool>, agent_id: Option<&str>, connections_limit: Option<i32>, connections_cursor: Option<&str>) -> Result<models::Project, Error<GetProjectError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_project_id = project_id;
    let p_header_x_organization_id = x_organization_id;
...
pub async fn get_worktree_options(configuration: &configuration::Configuration, project_id: &str, x_organization_id: Option<&str>, name: Option<&str>, branch: Option<&str>) -> Result<models::WorktreeOptions, Error<GetWorktreeOptionsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_project_id = project_id;
    let p_header_x_organization_id = x_organization_id;
    ...
    let uri_str = format!("{}/v1/projects/{project_id}/worktree-options", configuration.base_path, project_id=crate::apis::urlencode(p_path_project_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
