...
impl NativeRunAccepted {
    pub fn new(run_id: uuid::Uuid, session_id: uuid::Uuid, worktree_id: uuid::Uuid, status: Status, urls: models::RunAcceptedUrls) -> NativeRunAccepted {
        NativeRunAccepted {
            run_id,
            session_id,
            worktree_id,
