...
The package uses the published OpenAPI contract for every request and response type. It requires Node.js 24 or a modern browser. The release package name is a distribution setting and is independent of the repository codename.
